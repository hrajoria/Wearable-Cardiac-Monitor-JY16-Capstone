...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_UUID_16   (0x09u)
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_DATA_SEND_DATA   (0x0Du)
#define CY_BLE_SCN_PKT_0_INDEX_LOCAL_NAME   (0x00u)
#define CY_BLE_SCN_PKT_0_INDEX_SERVICE_UUID_16   (0x06u)
 ...
 */
#define CY_BLE_SEND_DATA_SERVICE_INDEX   (0x00u) /* Index of Send Data service in the cy_ble_customs array */
#define CY_BLE_SEND_DATA_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CY_BLE_SEND_DATA_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_SEND_DATA_SERVICE_HANDLE   (0x0010u) /* Handle of Send Data service */
#define CY_BLE_SEND_DATA_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0011u) /* Handle of Custom Characteristic characteristic declaration */
#define CY_BLE_SEND_DATA_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0012u) /* Handle of Custom Characteristic characteristic */
#define CY_BLE_SEND_DATA_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
