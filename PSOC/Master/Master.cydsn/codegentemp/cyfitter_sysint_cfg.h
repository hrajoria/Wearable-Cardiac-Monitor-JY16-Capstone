...
/* ARM CM4 */
    ...
    #define imuSPI_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t imuSPI_SCB_IRQ_cfg;

    #define ppgI2C_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t ppgI2C_SCB_IRQ_cfg;
