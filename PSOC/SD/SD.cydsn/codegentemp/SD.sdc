...
# Project: C:\Users\Nusair Islam\Desktop\PSOC\SD\SD.cydsn\SD.cyprj
# Date: Wed, 05 Apr 2023 22:36:25 GMT
#set_units -time ns
...
create_generated_clock -name {myUART_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 37 73} [list [get_pins {ClockBlock/ff_div_5}]]
create_generated_clock -name {sdSPI_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 5 9} [list [get_pins {ClockBlock/ff_div_6}]]
...
# Component constraints for C:\Users\Nusair Islam\Desktop\PSOC\SD\SD.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\Nusair Islam\Desktop\PSOC\SD\SD.cydsn\SD.cyprj
# Date: Wed, 05 Apr 2023 22:36:12 GMT
