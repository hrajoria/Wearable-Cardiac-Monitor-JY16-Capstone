...
/* ARM CM4 */
    ...
    /* imuSPI_SCB_IRQ */
    const cy_stc_sysint_t imuSPI_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)imuSPI_SCB_IRQ__INTC_NUMBER,
        .intrPriority = imuSPI_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };

    /* ppgI2C_SCB_IRQ */
    const cy_stc_sysint_t ppgI2C_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)ppgI2C_SCB_IRQ__INTC_NUMBER,
        .intrPriority = ppgI2C_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };
