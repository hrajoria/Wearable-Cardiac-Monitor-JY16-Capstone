...
*
* \globalvars
* \ref EZI2C_1_initVar - used to check initial configuration,
...
void EZI2C_1_Start(void)
{
    if (0U == EZI2C_1_initVar)
    {
        ...
        #if defined(EZI2C_1_SCB_IRQ__INTC_ASSIGNED)
            (void) Cy_SysInt_Init(&EZI2C_1_SCB_IRQ_cfg, &EZI2C_1_Interrupt);
        #endif /* (EZI2C_1_SCB_IRQ__INTC_ASSIGNED) */
    ...
    #if defined(EZI2C_1_SCB_IRQ__INTC_ASSIGNED)
        NVIC_EnableIRQ((IRQn_Type) EZI2C_1_SCB_IRQ_cfg.intrSrc);
    #endif /* (EZI2C_1_SCB_IRQ__INTC_ASSIGNED) */
